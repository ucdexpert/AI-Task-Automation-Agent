      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-card rounded-xl border border-[rgba(255,255,255,0.08)] p-8">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-text-primary">AI Task Automation</h1>
            <p className="text-text-muted text-sm mt-2">Welcome back — sign in to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-[rgba(255,255,255,0.08)] bg-background text-accent-blue focus:ring-accent-blue focus:ring-offset-0"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-to-r from-accent-blue to-accent-blueDark text-white font-semibold rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
            ...
            <button
              type="button"
              className="w-full h-11 border border-[rgba(255,255,255,0.08)] rounded-lg text-text-primary text-sm font-medium hover:bg-background transition-all flex items-center justify-center gap-2"
            >
